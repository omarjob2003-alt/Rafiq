...
export function AdminOrders() {
  ...
  return <AdminLayout>
    <h2 className="font-ar-heading text-lg font-semibold text-ink dark:text-ink-dark">{t('الطلبات', 'Orders')}</h2>

    <div className="mt-4 flex items-center gap-2 rounded-lg border border-line bg-cream px-3.5 py-2.5 dark:border-line-dark dark:bg-cream-dark">
